(function (w) {
    ...
    var Video = function (src, skip, timeout, href) {
        this.text = {
            wait: 'Wait % seconds...',
            skip: 'Skip >'
        };
        ...
        this.aTag = this._initATag(href);
        this.wrapper.appendChild(this.aTag);
    };
    ...
    Video.prototype._initATag = function (href) {
    ...
    var ClapprAds = Clappr.UICorePlugin.extend({
        ...
        playPreRoll: function (container) {
            ...
            // initialize video
            video = new Video(src, this._preRoll.skip, this._preRoll.timeout, this._preRoll.href);
        ...
        playMidRoll: function (container, index) {
            ...
            // initialize video
            video = new Video(src, this._midRoll.skip, this._midRoll.timeout, this._midRoll.href);
            ...
            video.onEnd = this._onMidRollEnd.bind(this, video, container.playback);
        },
        ...
        playPostRoll: function (container) {
            ...
            // initialize video
            video = new Video(src, undefined, undefined, this._postRoll.href);
        ...
        _onMidRollEnd: function (video, playback) {
            this._isAdPlaying = false;
